# -*- coding: utf-8 -*-
"""
FILE NAME:      B__v00_00_Plot_Filament_Length.py
...
def plot_fil_length(length_data,time_data,output_directory):
    """
    ...
    plt.plot(time_data,length_data,color = 'black',linewidth = 1.2)
...
if __name__ == '__main__':
    ...
    length_array = np.load(os.path.join(args.input_directory,"filament_length.npy"))
    time_array = np.load(os.path.join(args.input_directory,"filament_time_vals_all.npy"))
    
    plot_fil_length(length_array,time_array,args.output_directory)
