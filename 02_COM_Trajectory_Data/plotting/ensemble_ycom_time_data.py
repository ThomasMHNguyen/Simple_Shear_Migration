# -*- coding: utf-8 -*-
"""
FILE NAME:              ensemble_ycom_time_data.py
...
DESCRIPTION:            This script contains a function that will plot each 
                        the y-center of mass trajectory for each ensemble for
...
OUTPUT
FILES(S):               1) .PNG/.PDF/.EPS file that shows the y-center of mass
                        trajectory of all ensembles.
...
def ensemble_ycom_time_data(ensemble_data_df,output_dir):
    """
