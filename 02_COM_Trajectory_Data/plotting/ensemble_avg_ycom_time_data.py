# -*- coding: utf-8 -*-
"""
FILE NAME:              ensemble_avg_ycom_time_data.py
...
DESCRIPTION:            This script contains a function that plots the instantaneous
                        ensemble average y-center of mass data as a function of 
...
def ensemble_avg_ycom_time_data(ensemble_data_df,output_dir):
    """
    ...
    ensemble_data_df:           DataFrame that contains all ensemble
                                average data.
    output_directory:           Directory where the generated plots will be 
                                stored in.
    """
