...
def net_ycom_comp_mu_bar_scaling(data_df,fit_slope,fit_intercept,output_dir):
    ...
    plt.savefig(os.path.join(output_dir,'net_com_all.png'),
                format = 'png',dpi = 600,bbox_inches = 'tight')
    plt.savefig(os.path.join(output_dir,'net_com_all.pdf'),
                format = 'pdf',dpi = 600,bbox_inches = 'tight')
    plt.savefig(os.path.join(output_dir,'net_com_all.eps'),
