# -*- coding: utf-8 -*-
"""
FILE NAME:      A__v01_05_Brownian_nsterics_Shear.py
...
06Feb22         23) If code fails, option to restart the entire code. 
...
def fluid_velo(sim_c,x_vec):
    ...
    k_flow_factor = sim_c.kflow_freq
...
class Constants:
    ...
    def __init__(self,end_dir,rigid_func,slender_f,mubar,true_zeta_f,adpt_zeta_f,top, bottom,U_centerline,k_flow_phase,k_flow_factor,gap_criteria,force_power,
...
class run_parameters():
    ...
    def __init__(self,sim_params,end_time,start_time):
        ...
        self.parameter_df = pd.DataFrame(index = ['Random Seed','Filament Length','Filament Persistence Length','Filament s start','Filament s end',
                                              'Poiseuille U Centerline','Kolmogorov Frequency','Channel Upper Height','Channel Lower Height','Vertical Displacement',
...
def run_simulation(target_dir,rigid_type,mu_bar,rep):
    ...
    sim_c = Constants(end_dir = target_dir,rigid_func = rigid_type,
                                ...
                                top = 0, bottom = 1,
                                U_centerline = 0.00,k_flow_phase = 0,k_flow_factor = 0,
    ...
    dir_name = 'VD_{}/{}_H_{}/MB_{}/R_{}'.format(vert_displ_str,sim_c.rigidity_suffix,H_val_str,
