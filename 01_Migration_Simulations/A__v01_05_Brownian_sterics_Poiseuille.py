...
class Constants:
    ...
    channel_height,vert_displace,N,lp,reg_dt,adpt_dt,end_time,save_time):
        ...
        # self.rand_seed = 918696
        # self.rand_seed = 377129
        ...
        self.all_Nex_states = np.zeros((self.N,3,self.ar_length),dtype = float)
        self.all_adj_Nex_states = np.zeros((self.N,3,self.ar_length),dtype = float)
...
def run_simulation(target_dir,rigid_type,mu_bar,rep):
    ...
    sim_c = Constants(end_dir = target_dir,rigid_func = rigid_type,
                                ...
                                top = 0, bottom = 1,
                                U_centerline = 1,k_flow_phase = 0,k_flow_factor = 0,
