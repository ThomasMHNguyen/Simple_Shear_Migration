"""
FILE NAME:              net_ycom_mu_bar_violin.py

COMPLEMENTARY
SCRIPT(S)/
FILE(S):                Process_Filament_Flip_Data.py

DESCRIPTION:            This script contains a function that will plot the net drift (net 
                        y-center of mass displacement) of the filament flipping events as 
                        a function of mu_bar on a violin plot.
...
def net_ycom_mu_bar_violin(input_file,p_vals_df,flow_type,output_directory,file_name):
    """
    This function will take in the filament flipping data and plot the net 
    displacement based on the different mu_bar values and flipping direction
    on a violin plot.
